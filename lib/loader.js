    ...
    co(function* () {
        ...
        while (groups.length) {
            ...
            if (group.ratio == PixelRatio.X2) {
                ...
                let file2x = emitSprite.call(loader, query.name, meta2x.image, query.publicPath);
                rule2x = {
                    type: 'rule',
                    declarations: [{
                        type: 'declaration',
            ...
            let file = emitSprite.call(loader, query.name, meta.image, query.publicPath);
            let groupSelectors = [];
